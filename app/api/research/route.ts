...
function quickSnapshot(candidate: Candidate): QuickStockSnapshot {
  return {
    ...
    outstandingShares: candidate.outstandingShares ?? null,
    outstandingSharesAsOf: candidate.outstandingSharesAsOf ?? null,
    freeFloatShares: candidate.freeFloatShares ?? null,
    freeFloatPercent: candidate.freeFloatPercent ?? null,
    freeFloatAsOf: candidate.freeFloatAsOf ?? null,
    floatMarketCap: candidate.floatMarketCap ?? null,
    bars: candidate.bars,
    technical: {
